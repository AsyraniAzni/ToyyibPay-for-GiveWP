 ...
 * Plugin URI:  https://github.com/toyyibpay/toyyibpay-for-givewp
 * Description: ToyyibPay. Fair payment platform. | <a href="https://www.toyyibpay.com/enterprise/signup" target="_blank">Sign up Now</a>.
 * Version:     1.0.3
  ...
  class Give_ToyyibPay {
    ...
    private function includes() {
      ...
      if (is_admin()) {
        ...
        include GIVE_TOYYIBPAY_PLUGIN_DIR . '/includes/admin/give-toyyibpay-settings-metabox.php';
      }

      include GIVE_TOYYIBPAY_PLUGIN_DIR . '/includes/ToyyibPay_API.php';
      include GIVE_TOYYIBPAY_PLUGIN_DIR . '/includes/ToyyibPay_WPConnect.php';
